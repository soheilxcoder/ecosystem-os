...
8. `16-VISUAL-ASSETS-MASTER-PLAN.md` — the complete inventory of every icon, custom diagram, chart, illustration, and animation the product needs, with exact specs and a production checklist mapped to the roadmap's phases.
